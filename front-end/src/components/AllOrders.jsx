...
const AllOrders = () => {
    ...
    return (
        <div className="bg-green-100 min-h-screen p-6">
            <p className="text-3xl font-bold text-gray-900 mb-6 text-center">All Orders</p>
            <ToastContainer position="top-right" autoClose={3000} theme="dark" />

            <div className="overflow-x-auto">
                <table className="w-full border-collapse bg-white shadow-lg rounded-lg overflow-hidden">
                    <thead className="bg-green-300 text-gray-700 text-sm uppercase">
                        ...
                        {allorder &&
                            allorder.map((item, index) => (
                                <tr key={index} className="border-b last:border-none hover:bg-gray-100 transition">
                                    ...
                                    <td className="p-4 text-black">{item.user.username}</td>
                                    ...
                                    {item.book ? (
                                        ...
                                        <td colSpan="5" className="p-4 text-center text-red-600 font-medium">
